        ...
        <div>
          ...
          <div className="relative">
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="mr-5">
                <a
                  href=""
                  className="bg-[#2eaf5c] px-4 py-2 rounded-md text-medium hover:bg-[#1a6334] hover:ease-in-out transition-all duration-300"
                >
                  Gửi tin nhắn
                </a>
              </div>
          ...
          <div className="bg-backgroundColor mx-5 mb-5 mt-3 p-5 rounded-2xl">
            <h3 className="text-white text-3xl font-bold">
              Zuucifer<span className="text-[28px] opacity-70">#7005</span>
            </h3>
